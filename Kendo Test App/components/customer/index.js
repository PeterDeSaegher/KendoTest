...
var localData2 ={ttCustomer:[{Address:"276 North Drive",Address2:"",Balance:903.64,City:"Burlington",Comments:"This customer is on credit hold.",Contact:"Gloria Shepley",Country:"USA",CreditLimit:66700.0,CustNum:1,Discount:35,EmailAddress:"",Fax:"",Name:"Lift Tours",Phone:"(617) 450-0086",PostalCode:"01730",SalesRep:"HXM",State:"MA",Terms:"Net30"}]};
...
dsCustomersLocal2: new kendo.data.DataSource({
	transport:{
		read: function(options){
			options.success(localData2);    			
		}
	},
	schema: {   
		data: "ttCustomer",
